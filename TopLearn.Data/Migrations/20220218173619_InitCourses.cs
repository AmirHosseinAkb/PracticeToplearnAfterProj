        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseDescription = table.Column<string>(type: "nvarchar(800)", maxLength: 800, nullable: false),
                    CoursePrice = table.Column<int>(type: "int", nullable: false),
                    CourseDemoFileName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CourseImageName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CourseTags = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_CourseGroups_SubId",
                        column: x => x.SubId,
                        principalTable: "CourseGroups",
                        principalColumn: "GroupId",
